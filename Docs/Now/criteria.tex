...
\begin{figure}[h]
\center{\includegraphics[scale = 0.4]{Betteraccuracy3.png}}
...
\center{\includegraphics[scale = 0.4]{accuracyMethodsSkin1.png}} Size of train datset changes from 20 to 500 points.
\end{minipage}
\vfill
\begin{minipage}[c]{0.49\linewidth}
\center{\includegraphics[scale = 0.4]{accuracyMethodsSkin3.png}} Size of train datset changes from 20 to 166 (500 / 3) points.
\end{minipage}
...
\begin{figure}[h]
\begin{minipage}[c]{0.49\linewidth}
\center{\includegraphics[scale = 0.4]{accuracy2dim.png}} Size of train datset changes from 10 to 600 points.
\end{minipage}
\vfill
\begin{minipage}[c]{0.49\linewidth}
\center{\includegraphics[scale = 0.4]{accuracy2dim5.png}} Size of train datset changes from 10 to 300 (600 / 2) points.
\end{minipage}
